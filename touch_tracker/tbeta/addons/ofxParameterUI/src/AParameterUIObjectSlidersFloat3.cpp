...
AParameterUIObjectSlidersFloat3::AParameterUIObjectSlidersFloat3()
{
	type = PARAMETER_UI_OBJECT_TYPE_FLOAT_SLIDER3;
...
void AParameterUIObjectSlidersFloat3::init( string _name, int _x, int _y, int _width )
{
	paramTitle = _name;
	...
	height = sliders[2].posy + sliders[2].height;	
...
void AParameterUIObjectSlidersFloat3::setValue( float _val, int _index )
{
	currVal[_index] = _val;
...
string AParameterUIObjectSlidersFloat3::currValuesToString()
{	
	string _result = floatToString( currVal[0], 2 ) + ", " + floatToString( currVal[1], 2 ) + ", " + floatToString( currVal[2], 2 );
	
	return _result;
}

void AParameterUIObjectSlidersFloat3::update()
{
	if( p_floatValVec0 != NULL ) { setValue( *p_floatValVec0, 0 ); }
	if( p_floatValVec1 != NULL ) { setValue( *p_floatValVec1, 1 ); }
	if( p_floatValVec2 != NULL ) { setValue( *p_floatValVec2, 2 ); }	
}

void AParameterUIObjectSlidersFloat3::setRangesAndStartVal( float _low0, float _low1, float _low2, 
															...
															float _start0, float _start1, float _start2 )
{
	...
	minVal[2]  = _low2;
	maxVal[2]  = _high2;
	valDelta[2] = maxVal[2] - minVal[2];
	currVal[2] = _start2;
	sliders[2].setPos( valToFrac( currVal[2], 2 ) );
		
}


void AParameterUIObjectSlidersFloat3::render()
{
...
void AParameterUIObjectSlidersFloat3::mouseMotion( int _x, int _y )
{
...
void AParameterUIObjectSlidersFloat3::mouseDown( int _x, int _y, int _button )
{
...
void AParameterUIObjectSlidersFloat3::mouseUp( int _x, int _y, int _button )
{
...
AParameterUIObjectCheckbox*	AParameterUIObjectSlidersFloat3::addCheckbox( string _name, bool _startVal )
{
	AParameterUIObjectCheckbox* newCheckbox = new AParameterUIObjectCheckbox(); // must be created with new, AParameterUIObjectSlidersFloat3 newSlider will NOT work.
...
AParameterUIObjectPushButton* AParameterUIObjectSlidersFloat3::addPushButton( string _name )
{
	AParameterUIObjectPushButton* newPushButton = new AParameterUIObjectPushButton(); // must be created with new, AParameterUIObjectSlidersFloat3 newSlider will NOT work.
...
float AParameterUIObjectSlidersFloat3::valToFrac( float _val, int _index )
{
	float tmp = 0.0f;
...
float AParameterUIObjectSlidersFloat3::fracToVal( float _frac, int _index )
{
	float tmpVal = 0.0f;

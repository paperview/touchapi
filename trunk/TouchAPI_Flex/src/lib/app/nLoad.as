package app {
	...
	public class nLoad extends MovieClip
	{
		...
		public function nLoad(d:DisplayObject, infetchAmount:int, getFlickrID:String, infetchObject:String, insetX:int, insetY:int, insetScaleXY:int) 
		{
			thestage = d;
	...
	private function showPics():void 
		{	
			...
			for(var i:int=0; i<len; i++)
			{
				...
				url = "http://nui.mine.nu/constitution.jpg";
				if (fetchObject != ""){url = fetchObject;}

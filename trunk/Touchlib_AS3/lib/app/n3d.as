...
public class n3d extends Sprite
{
	...
	// ___________________________________________________________________ n3d
	...
	private function createAlbum()
	{
		...
		container.addEventListener( TUIOEvent.RollOverEvent, doRollOver );
		container.addEventListener( TUIOEvent.RollOutEvent, doRollOut );
		container.addEventListener( TUIOEvent.DownEvent, doPress );
/*

...
//		public var Brush:Class;
		...
		public function PaintSurface(sizeX:int, sizeY:int):void
		{
			...
			colorButton_0.addEventListener(TUIOEvent.DownEvent, function(){setColor(0.0, 0.0, 0.0);});									
			colorButton_1.addEventListener(TUIOEvent.DownEvent, function(){setColor(1.0, 0.0, 0.0);});	
			colorButton_2.addEventListener(TUIOEvent.DownEvent, function(){setColor(1.0, 0.5, 0.0);});									
			colorButton_3.addEventListener(TUIOEvent.DownEvent, function(){setColor(1.0, 1.0, 0.0);});
			colorButton_4.addEventListener(TUIOEvent.DownEvent, function(){setColor(0.0, 1.0, 0.0);});									
			colorButton_5.addEventListener(TUIOEvent.DownEvent, function(){setColor(0.5, 1.0, 0.5);});
			colorButton_6.addEventListener(TUIOEvent.DownEvent, function(){setColor(0.0, 0.0, 1.0);});									
			colorButton_7.addEventListener(TUIOEvent.DownEvent, function(){setColor(0.5, 0.0, 0.5);});									
			colorButton_8.addEventListener(TUIOEvent.DownEvent, function(){setColor(1.0, 0.0, 1.0);});
			colorButton_9.addEventListener(TUIOEvent.DownEvent, function(){setColor(1.0, 1.0, 1.0);});

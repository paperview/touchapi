package app.createMultiKey{
	...
	public class DrawNaturalKey extends Sprite {
		...
		private function makeKey() {
			...
			addEventListener(TUIOEvent.RollOutEvent, offKey);   // if Finger rolls off key, go to onSpriteRelease function
			addEventListener(TUIOEvent.RollOverEvent, onKey);   // if Finger rolls off key, go to onSpritePress function
		}

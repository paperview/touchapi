...
package app.createMultiKey {
	...
	public class AssemblePiano extends Sprite {			
		...
		var C1key = new Sound(new URLRequest("mp3/C1.mp3"));
		var D1key = new Sound(new URLRequest("mp3/D1.mp3"));
		var E1key = new Sound(new URLRequest("mp3/E1.mp3"));
		var F1key = new Sound(new URLRequest("mp3/F1.mp3"));
		var G1key = new Sound(new URLRequest("mp3/G1.mp3"));
		var A1key = new Sound(new URLRequest("mp3/A1.mp3"));
		var B1key = new Sound(new URLRequest("mp3/B1.mp3"));
		var C2key = new Sound(new URLRequest("mp3/C2.mp3"));	
		var D2key = new Sound(new URLRequest("mp3/D2.mp3"));
		var E2key = new Sound(new URLRequest("mp3/E2.mp3"));
		var F2key = new Sound(new URLRequest("mp3/F2.mp3"));
		var G2key = new Sound(new URLRequest("mp3/G2.mp3"));
		var A2key = new Sound(new URLRequest("mp3/A2.mp3"));
		var B2key = new Sound(new URLRequest("mp3/B2.mp3"));
		var C3key = new Sound(new URLRequest("mp3/C3.mp3"));			
		var Cs1key = new Sound(new URLRequest("mp3/Cs1.mp3"));
		var Ds1key = new Sound(new URLRequest("mp3/Ds1.mp3"));
		var Fs1key = new Sound(new URLRequest("mp3/Fs1.mp3"));
		var Gs1key = new Sound(new URLRequest("mp3/Gs1.mp3"));
		var As1key = new Sound(new URLRequest("mp3/As1.mp3"));		
		var Cs2key = new Sound(new URLRequest("mp3/Cs2.mp3"));
		var Ds2key = new Sound(new URLRequest("mp3/Ds2.mp3"));
		var Fs2key = new Sound(new URLRequest("mp3/Fs2.mp3"));
		var Gs2key = new Sound(new URLRequest("mp3/Gs2.mp3"));
		var As2key = new Sound(new URLRequest("mp3/As2.mp3"));
		...
		private function combineKeys(numNaturalKeys:int, numSharpKeys:int) {
			...
			for (var i = 0; i < numNaturalKeys; i++) {
				...
				subobj.addEventListener(TUIOEvent.RollOverEvent, onStartAudio);  // if Finger rolls over key, go to onStartAudio function
			}

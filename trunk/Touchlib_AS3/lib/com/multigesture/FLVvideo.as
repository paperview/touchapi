/* 
Class/Package name: FLVvideo
Description: Allows to add FLV video objects in the multitouch desktop
...
Usage example:
	var flv_video:FLVvideo = new FLVvideo("URL TO THE VIDEO");	// Make a new flv video object			
	thestage.addChild(flv_video);								// Add it to the stage	
*/
...
//	import flash.util.trace;
	...
	class FLVvideo extends RotatableScalable {
		// Items
		...
		public function FLVvideo(url:String) {
...
//			clickgrabber.graphics.beginFill(0xff00ff, 0.5);
			...
			pause_btn.addEventListener(TUIOEvent.DownEvent, buttontouch);
			play_btn.addEventListener(TUIOEvent.DownEvent, buttontouch);

package touchapi.core
{
	...
	/**
	* A simulation class - will render custom TUIOSocket situations dependant on a pre-defined list of actions.
	*/
...
// CONSTRUCTOR
//---------------------------------------------------------------------------------------------------------------------------------------------
		public function Simulator($target:DisplayObject, $action:String, $x:Number, $y:Number, $count:int, $radius:Number)
		{
			target = $target;
			action = $action;
			x = $x; 
